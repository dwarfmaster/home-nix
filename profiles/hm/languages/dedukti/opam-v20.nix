...
in
{
  ...
  selection = 
  {
    alt-ergo = 
    {
      ...
      opamInputs = 
      {
        inherit (selection) ocaml menhir dune cmdliner alt-ergo-parsers
        alt-ergo-lib;
      };
    ...
    alt-ergo-lib = 
    {
      ...
      opamInputs = 
      {
        inherit (selection) zarith stdlib-shims seq ocplib-simplex ocaml num
    ...
    alt-ergo-parsers = 
    {
      ...
      opamInputs = 
      {
        inherit (selection) stdlib-shims psmt2-frontend ocaml menhir dune
        camlzip alt-ergo-lib;
      };
      opamSrc = repoPath (repos.opam-repository.src) 
      {
    ...
    lambdapi = 
    {
      ...
      opamInputs = 
      {
        inherit (selection) yojson why3 timed stdlib-shims sedlex pratter
        ocaml menhir dune cmdliner bindlib alt-ergo;
      };
    ...
    why3 = 
    {
      ...
      opamInputs = 
      {
        inherit (selection) ocamlfind ocaml num
        menhir;
